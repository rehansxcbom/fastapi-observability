...
*   **Grafana:** A unified visualization platform to query traces in Tempo and build metric dashboards from Prometheus.
...
3.  **Visualize Data (Grafana):** Navigate to `http://127.0.0.1:3000` to build dashboards and query your application's trace logs.
